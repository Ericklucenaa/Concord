...
import { signInWithGoogle, resetPasswordWithEmail } from '../services/firebase';
import { Radio, Lock, Mail, User, ArrowRight, ArrowLeft, KeyRound } from 'lucide-react';
...
export default function AuthPage() {
  ...
  const handleForgotSubmit = async (e) => {
    ...
    try {
      ...
      setForgotSuccess(`Um e-mail de recuperação foi enviado para ${forgotEmail.trim()}. Verifique sua caixa de entrada e spam!`);
    } catch (err) {
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        {forgotSuccess && (
          <div style={{ backgroundColor: 'rgba(16, 185, 129, 0.15)', color: '#34d399', padding: '10px 14px', borderRadius: 'var(--radius-sm)', fontSize: 13, border: '1px solid rgba(16, 185, 129, 0.3)', margin: '0 0 14px' }}>
            {forgotSuccess}
          </div>
        )}
        ...
        {isForgotPassword ? (
          ...
          <form onSubmit={handleForgotSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div className="form-group">
              <label className="form-label" style={{ fontWeight: 700 }}>E-mail Cadastrado</label>
            ...
            >
              {isLoading ? 'Enviando e-mail...' : 'Enviar Link de Redefinição'}
            </button>
          ...
          <>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div className="form-group">
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    className="form-input"
                    style={{ width: '100%', paddingLeft: 36 }}
                    placeholder={isRegister ? 'Seu apelido' : 'usuario ou email@exemplo.com'}
                    value={username}
              ...
              <button
                ...
                className="btn btn-primary"
                disabled={isLoading}
                style={{ width: '100%', padding: '12px 0', fontSize: 15, marginTop: 4, fontWeight: 700 }}
              >
